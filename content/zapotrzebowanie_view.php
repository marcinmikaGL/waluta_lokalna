...
<table class="table table-hover">
 ...
 <thead>
    <tr>
            ...
            <th  id="nrSort" class="sort" onclick="changeSort('nr',1)" title="Sortowanie po: numer">tytuł zapotrzebowania<span id="nrKier"></span></th>
             ...
             <th id="nrSort" class="spady" onclick="changeSort('nr',1)" title="Sortowanie po: numer">data wygaśnięcia zapotrzebowania <span id="nrKier"></span></th>
              ...
              <th id="nrSort" class="spady" onclick="changeSort('nr',1)" title="Sortowanie po: numer">Edytuj<span id="nrKier"></span></th> 
...
<td class="spady"><button onClick="location.href='?page=user_view&id=6'">Edytuj </button   
